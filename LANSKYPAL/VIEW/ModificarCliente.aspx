        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <p class="text-center">
                    ...
                    <a href="Eliminarcliente.aspx" class="btn btn-danger">Eliminar</a>
                </p>
            </div>
        </div>
    </div>    
            ...
            <div class="col-md-4 jumbotron form-horizontal" role="form">      
                ...
                <label for="inputPassword" class="col-lg-4 control-label">Nombre</label>
                    <div class="col-lg-7">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="mtbNombre" runat="server" ErrorMessage="Debe Ingresar Nombre" Text="" Display="Dynamic" CssClass="alert-danger"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                <label for="inputPassword" class="col-lg-4 control-label">Direccion</label>
                    <div class="col-lg-7">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ControlToValidate="mtbDireccion" runat="server" ErrorMessage="Debe Ingresar Direccion" Text="" Display="Dynamic" CssClass="alert-danger"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ControlToValidate="mtbTelefono" runat="server" ErrorMessage="Debe Ingresar Telefono" Text="" Display="Dynamic" CssClass="alert-danger" ></asp:RequiredFieldValidator>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" CssClass="alert-danger" ControlToValidate="mtbTelefonoEmergencia" runat="server" ErrorMessage="Debe Ingresar Telefono Emergencia" Text="" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator4" runat="server" CssClass="alert-danger" ErrorMessage="Reingrese Telefono Emergencia" Type="Integer" ControlToValidate="mtbTelefonoEmergencia" Display="Dynamic" MinimumValue="10000000" MaximumValue="999999999" ></asp:RangeValidator>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" CssClass="alert-danger" ControlToValidate="mtbEmail" runat="server" ErrorMessage="Debe Ingresar EMAIL" Text="" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID=RegularExpressionValidator3 runat="server" CssClass="alert-danger" ErrorMessage="Email Invalido." ControlToValidate="mtbEmail" Display="Dynamic" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$"  />
                    </div>
                </div>
                    <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" ControlToValidate="mtbEmailEmergencia" runat="server" CssClass="alert-danger" ErrorMessage="Debe Ingresar EMAIL Emergencia" Text="" Display="Dynamic"></asp:RequiredFieldValidator>
